...
TRISB =  0b11010111
ANSELB=	0b00000111
WPUB	=	0b01010000 was: 0b00010000
		...
		14,15: RC6,7 Serial was: + MEM switch, now: 6: TX, 7 RX, 
TRISC = 	0b11100000
ANSELC=	0b00100000
WPUC	=	0b00011111
**/
...
#define	LM_MEM_SW_ON	((PORTA & 0x01) == 0)
#define	LM_MINUS_SW_ON	((PORTB & 0x10) == 0)
#define	LM_PLUS_SW_ON	((PORTB & 0x40) == 0)
// +++ for test only #define	LM_PLUS_SW_ON	((PORTB & 0x10) == 0)
